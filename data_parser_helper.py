...
# Used to determine if the p-tag passed in corresponds to the type of milk,
# if we were to use unpasteurized it would be too specifc. Only the type of
# milk should mention pazteurization
